...
mol new no_water_no_hydrogen.psf type {psf} waitfor all
...
for { set j 0 } { $j < $pc } { incr j } {  
        ...
        close $ff
        foreach i $c {
        if { [ file isdirectory temp_data_dir ] } {
...
source ../Scripts/Tcl_Scripts/trajectory_smooth.tcl 
source ../Scripts/Analysis_Scripts/clustering_configuration.tcl
...
if { [ file isdirectory protein_cluster_data ] } {
        # Directory is already there
        } else {
                mkdir temp_data_dir
        }
